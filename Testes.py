...
class TestEverythingInOneSingleFile(unittest.TestCase):
    ...
    def test_trabalho_oficial_fator_friccao_CALCULADO(self):
        ...
        def definindo_sistema():
            ...
            duto_AC = Duto(res_A, no_C, vazao_1, 0, -8.2185 * vazao_1 ** 2 + 16.707 * vazao_1 + 47.332, 304.8, 0.3048,
                           0, perdas_singulares, 0.00026)
            duto_CD = Duto(no_C, no_D, vazao_2, 0, 0, 304.8, 0.2032, 0, perdas_singulares, 0.00026)
            duto_DE = Duto(no_D, no_E, vazao_3, 0, 0, 304.8, 0.2032, 0, perdas_singulares, 0.00026)
            duto_EB = Duto(no_E, res_B, vazao_4, 0, 0, 152.4, 0.3048, 0, perdas_singulares, 0.00026)
            duto_EF = Duto(no_E, no_F, vazao_5, 0, 0, 396.24, 0.2032, 0, perdas_singulares, 0.00026)
            duto_FJ = Duto(no_F, no_J, vazao_6, 0, 0, 487.68, 0.254, 0, perdas_singulares, 0.00026)
            duto_JK = Duto(no_J, no_K, vazao_7, 0, 0, 304.8, 0.254, 0, perdas_singulares, 0.00026)
            duto_KI = Duto(no_K, no_I, vazao_8, 0, 0, 396.24, 0.254, 0, perdas_singulares, 0.00026)
            duto_IH = Duto(no_I, no_H, vazao_9, 0, 0, 274.32, 0.3048, 0, perdas_singulares, 0.00026)
            duto_HG = Duto(no_H, no_G, vazao_10, 0, 0, 274.32, 0.254, 0, perdas_singulares, 0.00026)
            duto_CG = Duto(no_C, no_G, vazao_11, 0, 0, 304.8, 0.254, 0, perdas_singulares, 0.00026)
            duto_DH = Duto(no_D, no_H, vazao_12, 0, 0, 365.76, 0.254, 0, perdas_singulares, 0.00026)
            duto_DI = Duto(no_D, no_I, vazao_13, 0, 0, 457.2, 0.254, 0, perdas_singulares, 0.00026)
            duto_EI = Duto(no_E, no_I, vazao_14, 0, 0, 426.72, 0.254, 0, perdas_singulares, 0.00026)
            duto_EJ = Duto(no_E, no_J, vazao_15, 0, 0, 609.6, 0.3048, 0, perdas_singulares, 0.00026)
            duto_JI = Duto(no_J, no_I, vazao_16, 0, 0, 365.76, 0.2032, 0, perdas_singulares, 0.00026)
    ...
    def test_exemplo_11_5_Potter_SEM_BOMBA_fator_friccao_CALCULADO(self):
        ...
        def definindo_sistema():
            ...
            vazao_2 = sp.symbols('x[1]')
            vazao_3 = sp.symbols('x[2]')
            duto_AB = Duto(res_A, no_B, vazao_1, 0, 0, 50, 0.15, 0, 2, 0.00026)
            duto_BC = Duto(no_B, res_C, vazao_2, 0, 0, 100, 0.10, 0, 1, 0.00026)
            duto_BD = Duto(no_B, res_D, vazao_3, 0, 0, 300, 0.10, 0, 1, 0.00026)
